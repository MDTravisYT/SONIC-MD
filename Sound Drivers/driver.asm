...
PSG_Index:
		...
		dc.l PSG4, PSG5, PSG6
		dc.l PSG7, PSG8, PSG9
PSG1:		incbin	"Sound Drivers/psg/psg1.bin"
PSG2:		incbin	"Sound Drivers/psg/psg2.bin"
PSG3:		incbin	"Sound Drivers/psg/psg3.bin"
PSG4:		incbin	"Sound Drivers/psg/psg4.bin"
PSG6:		incbin	"Sound Drivers/psg/psg6.bin"
PSG5:		incbin	"Sound Drivers/psg/psg5.bin"
PSG7:		incbin	"Sound Drivers/psg/psg7.bin"
PSG8:		incbin	"Sound Drivers/psg/psg8.bin"
PSG9:		incbin	"Sound Drivers/psg/psg9.bin"
; ---------------------------------------------------------------------------
...
; loc_71B5A:
.updateloop:
		btst	#0,(Z80BUS).l		; Is the z80 busy?
...
; ---------------------------------------------------------------------------
Kos_Z80:
		incbin	"Sound Drivers/z80.bin"
		even

; ---------------------------------------------------------------------------
; Music data
; ---------------------------------------------------------------------------
Music81:	incbin	"Sound Drivers/music/Mus81 - GHZ.bin"
		even
Music82:	incbin	"Sound Drivers/music/Mus82 - LZ.bin"
		even
Music83:	incbin	"Sound Drivers/music/Mus83 - MZ.bin"
		even
Music84:	incbin	"Sound Drivers/music/Mus84 - SLZ.bin"
		even
Music85:	incbin	"Sound Drivers/music/Mus85 - SYZ.bin"
		even
Music86:	incbin	"Sound Drivers/music/Mus86 - SBZ.bin"
		even
Music87:	incbin	"Sound Drivers/music/Mus87 - Invincibility.bin"
		even
Music88:	incbin	"Sound Drivers/music/Mus88 - Extra Life.bin"
		even
Music89:	incbin	"Sound Drivers/music/Mus89 - Special Stage.bin"
		even
Music8A:	incbin	"Sound Drivers/music/Mus8A - Title Screen.bin"
		even
Music8B:	incbin	"Sound Drivers/music/Mus8B - Ending.bin"
		even
Music8C:	incbin	"Sound Drivers/music/Mus8C - Boss.bin"
		even
Music8D:	incbin	"Sound Drivers/music/Mus8D - FZ.bin"
		even
Music8E:	incbin	"Sound Drivers/music/Mus8E - Sonic Got Through.bin"
		even
Music8F:	incbin	"Sound Drivers/music/Mus8F - Game Over.bin"
		even
Music90:	incbin	"Sound Drivers/music/Mus90 - Continue Screen.bin"
		even
Music91:	incbin	"Sound Drivers/music/Mus91 - Credits.bin"
		even
Music92:	incbin	"Sound Drivers/music/Mus92 - Drowning.bin"
		even
Music93:	incbin	"Sound Drivers/music/Mus93 - Get Emerald.bin"
		even
...
; Sound effect data
; ---------------------------------------------------------------------------
SoundA0:	incbin	"Sound Drivers/sfx/SndA0 - Jump.bin"
		even
SoundA1:	incbin	"Sound Drivers/sfx/SndA1 - Lamppost.bin"
		even
SoundA2:	incbin	"Sound Drivers/sfx/SndA2.bin"
		even
SoundA3:	incbin	"Sound Drivers/sfx/SndA3 - Death.bin"
		even
SoundA4:	incbin	"Sound Drivers/sfx/SndA4 - Skid.bin"
		even
SoundA5:	incbin	"Sound Drivers/sfx/SndA5.bin"
		even
SoundA6:	incbin	"Sound Drivers/sfx/SndA6 - Hit Spikes.bin"
		even
SoundA7:	incbin	"Sound Drivers/sfx/SndA7 - Push Block.bin"
		even
SoundA8:	incbin	"Sound Drivers/sfx/SndA8 - SS Goal.bin"
		even
SoundA9:	incbin	"Sound Drivers/sfx/SndA9 - SS Item.bin"
		even
SoundAA:	incbin	"Sound Drivers/sfx/SndAA - Splash.bin"
		even
SoundAB:	incbin	"Sound Drivers/sfx/SndAB.bin"
		even
SoundAC:	incbin	"Sound Drivers/sfx/SndAC - Hit Boss.bin"
		even
SoundAD:	incbin	"Sound Drivers/sfx/SndAD - Get Bubble.bin"
		even
SoundAE:	incbin	"Sound Drivers/sfx/SndAE - Fireball.bin"
		even
SoundAF:	incbin	"Sound Drivers/sfx/SndAF - Shield.bin"
		even
SoundB0:	incbin	"Sound Drivers/sfx/SndB0 - Saw.bin"
		even
SoundB1:	incbin	"Sound Drivers/sfx/SndB1 - Electric.bin"
		even
SoundB2:	incbin	"Sound Drivers/sfx/SndB2 - Drown Death.bin"
		even
SoundB3:	incbin	"Sound Drivers/sfx/SndB3 - Flamethrower.bin"
		even
SoundB4:	incbin	"Sound Drivers/sfx/SndB4 - Bumper.bin"
		even
SoundB5:	incbin	"Sound Drivers/sfx/SndB5 - Ring.bin"
		even
SoundB6:	incbin	"Sound Drivers/sfx/SndB6 - Spikes Move.bin"
		even
SoundB7:	incbin	"Sound Drivers/sfx/SndB7 - Rumbling.bin"
		even
SoundB8:	incbin	"Sound Drivers/sfx/SndB8.bin"
		even
SoundB9:	incbin	"Sound Drivers/sfx/SndB9 - Collapse.bin"
		even
SoundBA:	incbin	"Sound Drivers/sfx/SndBA - SS Glass.bin"
		even
SoundBB:	incbin	"Sound Drivers/sfx/SndBB - Door.bin"
		even
SoundBC:	incbin	"Sound Drivers/sfx/SndBC - Teleport.bin"
		even
SoundBD:	incbin	"Sound Drivers/sfx/SndBD - ChainStomp.bin"
		even
SoundBE:	incbin	"Sound Drivers/sfx/SndBE - Roll.bin"
		even
SoundBF:	incbin	"Sound Drivers/sfx/SndBF - Get Continue.bin"
		even
SoundC0:	incbin	"Sound Drivers/sfx/SndC0 - Basaran Flap.bin"
		even
SoundC1:	incbin	"Sound Drivers/sfx/SndC1 - Break Item.bin"
		even
SoundC2:	incbin	"Sound Drivers/sfx/SndC2 - Drown Warning.bin"
		even
SoundC3:	incbin	"Sound Drivers/sfx/SndC3 - Giant Ring.bin"
		even
SoundC4:	incbin	"Sound Drivers/sfx/SndC4 - Bomb.bin"
		even
SoundC5:	incbin	"Sound Drivers/sfx/SndC5 - Cash Register.bin"
		even
SoundC6:	incbin	"Sound Drivers/sfx/SndC6 - Ring Loss.bin"
		even
SoundC7:	incbin	"Sound Drivers/sfx/SndC7 - Chain Rising.bin"
		even
SoundC8:	incbin	"Sound Drivers/sfx/SndC8 - Burning.bin"
		even
SoundC9:	incbin	"Sound Drivers/sfx/SndC9 - Hidden Bonus.bin"
		even
SoundCA:	incbin	"Sound Drivers/sfx/SndCA - Enter SS.bin"
		even
SoundCB:	incbin	"Sound Drivers/sfx/SndCB - Wall Smash.bin"
		even
SoundCC:	incbin	"Sound Drivers/sfx/SndCC - Spring.bin"
		even
SoundCD:	incbin	"Sound Drivers/sfx/SndCD - Switch.bin"
		even
SoundCE:	incbin	"Sound Drivers/sfx/SndCE - Ring Left Speaker.bin"
		even
SoundCF:	incbin	"Sound Drivers/sfx/SndCF - Signpost.bin"
		even

; ---------------------------------------------------------------------------
; Special sound effect data
; ---------------------------------------------------------------------------
SoundD0:	incbin	"Sound Drivers/sfx/SndD0 - Waterfall.bin"
		even
