...
IllegalInstr:
	__ErrorMessage "Illegal instruction. %<endl>You have been charged $0.00.", _eh_default
...
TrapvInstr:
	__ErrorMessage "TRAP Instruction encountered. %<endl>It's cold in here.", _eh_default
